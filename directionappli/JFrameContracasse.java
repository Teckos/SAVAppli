  ...
  private void Remplir_ComboType(){
   ...
   private void Remplir_ComboNom(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Appareils de Contrat-Casse et Autre Types d'Intervention");
        ...
        Combo_ty.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tablette", "Téléphone", " " }));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ComboPanne, 0, 132, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(ComboEtat, 0, 132, Short.MAX_VALUE)
                            .addComponent(type_inter))))
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(747, 659));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        String requete="INSERT INTO appareil(N_Serie,Date_E,Date_R,Date_S,N_Dossier,Type_App,Etat,Description,Id_Intervention,Id_Intervenant,Id_panne,Id_Materiel,Id_MO,N_BL)\n"+
                ...
                "(select Id_Intervention from intervention where type_In='"+T_I+"'),'"+U+"',\n"+
