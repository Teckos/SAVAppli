...
public class JFrameMainDoeuvre extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String T_App=type_ap.getText();
        ...
        stm.executeUpdate(requete); 
         ...
         JOptionPane.showMessageDialog(null,"Main d'Oeuvre Ajoutée avec succès");
       }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
         try{
          ...
          stm=maConnexion.get_connexion().createStatement();
           int p= JOptionPane.showConfirmDialog((Component)null, "Vous être sûr de vouloir supprimer cette Main d'Oeuvre?", "Informations saisies", JOptionPane.OK_OPTION);    
       if (p==0)
       {
