 ...
 * @author khaoula
 */
public class JFrameProductivitéEtMargeModifiée extends javax.swing.JFrame {
    Statement stm;
...
private void Fonction_Tous_Tous(){
         ...
         String D_R1 = ((JTextField)date_r1.getDateEditor().getUiComponent()).getText();
       try{
              ...
              String sql="select A.N_Serie,A.N_Dossier,A.Date_E as Date_Entrée,A.Date_R as 'Date Réparation',A.Heure_R as 'Heure Réparation',A.Type_App ,I.type_In AS Intervention,A.Etat,P.type as Panne,A.Description,MO.Type_MO as Main_oeuvre,MA.Nom as Façade,MA.Type_Mat as Appareil,MA.Couleur,II.Nom\n" +
                         ...
                         "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                         " AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' ORDER BY A.Etat,P.type,A.Heure_R,MO.Main_Oeuvre,Façade";
               stm=maConnexion.get_connexion().createStatement();
               rs=stm.executeQuery(sql);
       ...
       try{
             // dt.setRowCount(0);
              String sql="select count(A.N_Serie) as nbr_rep\n" +
                         ...
                         "AND MO.`Id_MO`=A.`Id_MO`\n" +
                         "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                         " AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Etat='Réparé'";
              stm=maConnexion.get_connexion().createStatement();
              rs=stm.executeQuery(sql);
              if(rs.first())
                {
       ...
       try{
             // dt.setRowCount(0);
              String sql="select count(A.N_Serie) as nbr_nn\n" +
                         ...
                         "AND MO.`Id_MO`=A.`Id_MO`\n" +
                         "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                         " AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Etat='Non Réparé'";
             stm=maConnexion.get_connexion().createStatement();
             rs=stm.executeQuery(sql);
             if(rs.first())
                {
       ...
       try{
             // dt.setRowCount(0);
              String sql="select count(A.N_Serie) as nbr\n" +
                          ...
                          "AND MO.`Id_MO`=A.`Id_MO`\n" +
                          "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' ";
             stm=maConnexion.get_connexion().createStatement();
              rs=stm.executeQuery(sql);
               if(rs.first())
                {
       ...
       double p_a=0,p_v=0,m=0;
       double tau=0,pa_s=0,result_s=0;
       /*String sql1="select Prix_Achat,Taux_Conversion\n" +
                          "from materiel\n" +
                          "where Date_Utilisation='"+D_R+"' ";*/
       String sql1="select Prix_Achat,Taux_Conversion\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' and M.Id_Materiel!='1' ";
       ...
       try{
            ...
            rs1=stm.executeQuery(sql1); 
              ...
              for(int i=1;i<100000;i++)
             {
                 if(rs1.absolute(i))
                 {
                 tau = rs1.getDouble("Taux_Conversion");
                // System.out.println(tva);
                 pa_s = rs1.getDouble("Prix_Achat");
...
private void Fonction_Tous_Util(){
       ...
       try{
              ...
              String sql="select A.N_Serie,A.N_Dossier,A.Date_E as Date_Entrée,A.Date_R as 'Date Réparation',A.Heure_R as 'Heure Réparation',A.Type_App ,I.type_In AS Intervention,A.Etat,P.type as Panne,A.Description,MO.Type_MO as Main_oeuvre,MA.Nom as Façade,MA.Type_Mat as Appareil,MA.Couleur,II.Nom\n" +
                         ...
                         "AND MO.`Id_MO`=A.`Id_MO`\n" +
                         "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                         " AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"') "+
       ...
       String sql1="select Prix_Achat,Taux_Conversion\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"') and M.Id_Materiel!='1'";
       String sql2="select sum(Prix_Vente) as v\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"')";
...
String D_R1 = ((JTextField)date_r1.getDateEditor().getUiComponent()).getText();
       try{
              ...
              String sql="select A.N_Serie,A.N_Dossier,A.Date_E as Date_Entrée,A.Date_R as 'Date Réparation',A.Heure_R as 'Heure Réparation',A.Type_App ,I.type_In AS Intervention,A.Etat,P.type as Panne,A.Description,MO.Type_MO as Main_oeuvre,MA.Nom as Façade,MA.Type_Mat as Appareil,MA.Couleur,II.Nom\n" +
                         ...
                         "AND MO.`Id_MO`=A.`Id_MO`\n" +
                         "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                         " AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervention=(select Id_Intervention from intervention where type_In='"+ComboIntervention.getSelectedItem()+"') "+
                         "ORDER BY A.Etat,A.Heure_R,MO.Main_Oeuvre,Façade";
               stm=maConnexion.get_connexion().createStatement();
               rs=stm.executeQuery(sql);
               TableProd.setModel(DbUtils.resultSetToTableModel(rs));
       ...
       String sql1="select Prix_Achat,Taux_Conversion\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervention=(select Id_Intervention from intervention where type_In='"+ComboIntervention.getSelectedItem()+"') and M.Id_Materiel!='1' ";
       String sql2="select sum(Prix_Vente) as v\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervention=(select Id_Intervention from intervention where type_In='"+ComboIntervention.getSelectedItem()+"') ";
...
private void Fonction_Interv_Util(){
    ...
    String D_R1 = ((JTextField)date_r1.getDateEditor().getUiComponent()).getText();
       ...
       try{
             // dt.setRowCount(0);
              String sql="select count(A.N_Serie) as nbr\n" +
                          ...
                          "AND MO.`Id_MO`=A.`Id_MO`\n" +
                          "AND II.`Id_Intervenant`=A.`Id_Intervenant`\n" +
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"') AND A.Id_Intervention=(select Id_Intervention from intervention where type_In='"+ComboIntervention.getSelectedItem()+"') "
                      + "";
             stm=maConnexion.get_connexion().createStatement();
              rs=stm.executeQuery(sql);
               if(rs.first())
       ...
       String sql1="select Prix_Achat,Taux_Conversion\n" +
                          ...
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"')"
               + "AND A.Id_Intervention=(select Id_Intervention from intervention where type_In='"+ComboIntervention.getSelectedItem()+"') and M.Id_Materiel!='1' ";
       String sql2="select sum(Prix_Vente) as v\n" +
                          "from materiel M,appareil A\n" +
                          "where M.Id_Materiel=A.Id_Materiel\n"+
                          "AND A.Date_R BETWEEN '"+D_R+"' AND '"+D_R1+"' AND A.Id_Intervenant=(select Id_Intervenant from intervenant where Nom='"+ComboUtil.getSelectedItem()+"') "
    ...
    public JFrameProductivitéEtMargeModifiée() {
        initComponents();
    ...
    private void initComponents() {
        ...
        date_r1 = new com.toedter.calendar.JDateChooser();
        ...
        date_r1.setDateFormatString("yyyy-MM-dd");
        date_r1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        date_r1.setInheritsPopupMenu(true);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(marge_b, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(date_r1, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(date_r1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameProductivitéEtMargeModifiée.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameProductivitéEtMargeModifiée().setVisible(true);
            }
        });
    }
    ...
    private com.toedter.calendar.JDateChooser date_r1;
