...
public class JFrameRechercheAppareil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        n_sd.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(n_serie.isSelected()==true && n_dossier.isSelected()==false)
        {
         ...
         try{
             // dt.setRowCount(0);
              String sql="select A.N_Serie,A.N_Dossier,A.Date_E as Date_Entrée,A.Date_R as Date_Réparation,A.Type_App ,I.type_In AS Intervention,A.Etat,P.type as Panne,A.Description,MO.Main_Oeuvre,MA.Nom as Façade,MA.Type_Mat as Appareil,MA.Couleur,II.Nom\n" +
