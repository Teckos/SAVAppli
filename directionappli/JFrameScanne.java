...
import static groovyjarjarasm.asm.commons.GeneratorAdapter.AND;
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(88, 88, 88)
                                .addComponent(cmpt, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(26, 26, 26)
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
       ...
       try{
        ...
        stm.executeUpdate(requete); 
         ...
         {
             String requete="INSERT INTO appareil(N_Serie,Date_E,Date_R,Date_S,N_Dossier,Type_App,Etat,Description,Id_Intervention,Id_Intervenant,Id_panne,Id_Materiel,N_BL)\n"+
                "VALUES ('"+N_S+"','"+D_E+"','"+D_R+"','"+D_S+"','"+N_D+"','"+Combo_ty.getSelectedItem()+"','"+ComboEtat.getSelectedItem()+"','"+D+"', \n"+
                "1,'"+U+"',\n"+
                "(select Id_panne from panne where type='"+ComboPanne.getSelectedItem()+"'),1,1) " ;
        //Exécuter la requête
       try{
         stm=maConnexion.get_connexion().createStatement();
        // stm.executeQuery(requete); ne passe pas pour l'insertion dans mysql
