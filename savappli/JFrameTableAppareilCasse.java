 ...
 * @author khaoula
 */
public class JFrameTableAppareilCasse extends javax.swing.JFrame {
...
"AND B.N_BL=A.N_BL\n" +
"AND A.`N_BL`='2' AND A.Date_S!='0000-00-00'\n" +
...
"and A.Type_App='Téléphone'\n" +
"AND A.Id_Intervention='2'\n" +
"AND N_BL='2' AND A.Date_S!='0000-00-00'\n" +
"group by P.type";
              String sql1="select count(N_Serie) as T\n" +
"from appareil A,panne P\n" +
"where A.Etat='Non Réparé'\n" +
...
"AND N_BL='2' AND A.Date_S!='0000-00-00'\n" ;
     ...
     */
    public JFrameTableAppareilCasse() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Total Appareil à livrer :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameTableAppareilCasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameTableAppareilCasse().setVisible(true);
            }
        });
    }
