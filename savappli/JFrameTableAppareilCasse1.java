 ...
 * @author khaoula
 */
public class JFrameTableAppareilCasse1 extends javax.swing.JFrame {
...
"AND N_BL='2' AND A.Date_S!='0000-00-00'\n" ;
     ...
     */
    public JFrameTableAppareilCasse1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameTableAppareilCasse1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameTableAppareilCasse1().setVisible(true);
            }
        });
    }
