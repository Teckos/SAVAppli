 ...
 * @author khaoula
 */
public class JFrameTableAppareilRéparation extends javax.swing.JFrame {
...
"AND N_BL='1'\n" ;
     ...
     */
    public JFrameTableAppareilRéparation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        telRep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                telRepActionPerformed(evt);
            }
        });
    ...
    private void telRepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_telRepActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_telRepActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameTableAppareilRéparation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameTableAppareilRéparation().setVisible(true);
            }
        });
    }
